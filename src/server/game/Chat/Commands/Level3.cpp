...
bool ChatHandler::HandleNerfCommand(const char* args)
{
	...
	CreatureTemplate* info = (CreatureTemplate*)crt->GetCreatureInfo();
	if(info == NULL) {
	...
	cell.Visit(cell.GetCellCoord(), obj_worker, *player->GetMap(), 1000, 0, 0);
