...
class Unit : public WorldObject
{
    public:
        ...
        void CalcAbsorbResist(Unit *pVictim, SpellSchoolMask schoolMask, DamageEffectType damagetype, uint32& damage, uint32 *absorb, uint32 *resist, SpellEntry const *spellInfo = NULL);
