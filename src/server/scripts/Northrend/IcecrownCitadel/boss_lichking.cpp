...
#define GOSSIP_START_EVENT "Wir sind soweit, Fordring!"

enum Yells
{
	SAY_INTRO_1_KING			=	-1000660,
	SAY_INTRO_2_TIRION			=	-1000661,
	SAY_INTRO_3_KING			=	-1000662,
	SAY_INTRO_4_TIRION			=	-1000663,
	SAY_INTRO_5_KING			=	-1000664,
	SAY_AGGRO_KING				=	-1000665,
	SAY_REMORSELESS_WINTER		=	-1000666,
	SAY_RANDOM_1				=	-1000667,
	SAY_RANDOM_2				=	-1000668,
	SAY_KILL_1					=	-1000669,
	SAY_KILL_2					=	-1000670,
	SAY_BERSERK					=	-1000671,
	SAY_ENDING_1_KING			=	-1000672,
	SAY_ENDING_2_KING			=	-1000673,
	SAY_ENDING_3_KING			=	-1000674,
	SAY_ENDING_4_KING			=	-1000675,
	SAY_ENDING_5_TIRION			=	-1000676,
	SAY_ENDING_6_KING			=	-1000677,
	SAY_ENDING_7_KING			=	-1000678,
	SAY_ENDING_8_TIRION			=	-1000679,
	SAY_ENDING_9_FATHER			=	-1000680,
	SAY_ENDING_10_TIRION		=	-1000681,
	SAY_ENDING_11_FATHER		=	-1000682,
	SAY_ENDING_12_KING			=	-1000683,
	SAY_DEATH_KING				=	-1000684,	
	SAY_ESCAPE_FROSTMOURNE		=	-1000685,
	SAY_HARVEST_SOUL			=	-1000686,
	SAY_DEVOURED_FROSTMOURNE	=	-1000687,
	SAY_SUMMON_VALKYR			=	-1000688,
	SAY_BROKEN_ARENA			=	-1000689,
	SAY_10_PROZENT				=	-1000690, 
};
...
struct boss_tirion_iccAI : public ScriptedAI
{
...
struct mob_Ice_PulsAI : public ScriptedAI
{
    mob_Ice_PulsAI(Creature *pCreature) : ScriptedAI(pCreature) 
    {
...
struct mob_ghoul_iccAI : public ScriptedAI
{
    mob_ghoul_iccAI(Creature *pCreature) : ScriptedAI(pCreature)
    {
    }
...
CreatureAI* GetAI_mob_ghoul_icc(Creature* pCreature)
{
    return new mob_ghoul_iccAI(pCreature);
}
...
CreatureAI* GetAI_mob_Ice_Puls(Creature* pCreature)
{
    return new mob_Ice_PulsAI(pCreature);
}
...
bool GossipSelect_boss_tirion_icc(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    if (uiAction == GOSSIP_ACTION_INFO_DEF+1)
    {
        ...
        ((boss_tirion_iccAI*)pCreature->AI())->StartEvent();
    }
    return true;
}
...
void AddSC_boss_lichking()
{
    ...
    newscript->GetAI = &GetAI_mob_Ice_Puls;
    newscript->RegisterSelf();
    ...
    newscript->GetAI = &GetAI_mob_ghoul_icc;
    newscript->RegisterSelf();
