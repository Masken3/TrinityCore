...
{
	SAY_AGGRO			=	-1000516,
	SAY_VAMP_BITE_1		=	-1000517,	
	SAY_VAMP_BITE_2		=	-1000518,
	SAY_SWARM_SHADOWS	=	-1000519,
	SAY_PACT_DARKFALLEN	=	-1000520,
	SAY_MIND_CONTROLL	=	-1000521,
	SAY_AIR_PHASE		=	-1000522,
	SAY_BERSERK			=	-1000523,
	SAY_DEATH			=	-1000524,
};
...
struct blood_queen_lanathelAI : public ScriptedAI
{
    blood_queen_lanathelAI(Creature *pCreature) : ScriptedAI(pCreature)
	{
...
CreatureAI* GetAIblood_queen_lanathelAI(Creature* pCreature)
{
    return new blood_queen_lanathelAI (pCreature);
}
...
void AddSC_blood_queen_lanathel()
{
     ...
     newscript->Name = "blood_queen_lanathel";
     newscript->GetAI = &GetAIblood_queen_lanathelAI;
